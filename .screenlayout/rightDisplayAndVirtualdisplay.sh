...
xrandr --setmonitor eizo-virt-left 1320/345x1080/285+0+0 DP2-2
# xrandr --setmonitor eizo-virt-left 1320/345x1080/285+1920+0 DP2-2
xrandr --setmonitor eizo-virt-right 600/130x1080/285+1320+0 none
# xrandr --setmonitor eizo-virt-right 600/130x1080/285+3240+0 none
xrandr --output eDP1 --off --output DP1 --off --output DP2 --off --output DP2-1 --off --output DP2-2 --primary --mode 1920x1080 --pos 1920x0 --rotate normal --crtc 1 --output DP2-3 --off --output HDMI1 --off --output HDMI2 --off --output VIRTUAL1 --off
